...
import { RouteGuard, RouteParams, QueryParams, RouteDefinition } from '../router';
...
export class AuthGuardFactory {
  ...
  createZKGuard(options: {
    ...
    return {
      ...
      canActivate: async (params: RouteParams, query: QueryParams, route?: RouteDefinition) => {
...
onFail: (params: RouteParams, query: QueryParams, route?: RouteDefinition) => {
