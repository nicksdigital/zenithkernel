...
import { useState, useRef, useEffect, useMemo } from '../jsx-runtime';
...
function ReactiveCounter(props: CounterProps): React.ReactElement {
  ...
  return (
    <div
      ...
      data-reactive="true"
      data-ecs-entity={props.ecsEntity}
    >
...
const ReactiveCounterIsland: IslandComponent = {
  async mount(element: HTMLElement, props: CounterProps = {}, context: any = {}): Promise<void> {
    ...
    // Mount the component using ReactDOM
    ...
    root.render(<ReactiveCounter {...counterProps} />);
    
    // Register cleanup handler with the element if needed
