...
module.exports = {
  ...
  options: {
    ...
    doNotFollow: {
      ...
      path: ['node_modules', 'old', 'vendors', 'dist', 'build', 'out', 'coverage', 'test', 'spec', 'examples', 'demo', 'docs']
    },
    ...
    */
    extraExtensionsToScan: [".json", ".md",".tsx", ".py"],
...
// generated: dependency-cruiser@16.10.2 on 2025-06-04T18:57:07.061Z
